...
for epoch in range(epochs):
    f = open('/root/volume/MidProject/cutout_stripe/stripe_15.txt','w')
    ...
    save_acc = str(epoch)+'\t'+str(test_acc)+'\n'
    f.write(save_acc)
    ...
    if best_acc < test_acc:
        best_acc = test_acc
        torch.save(model.state_dict(), '/root/volume/MidProject/cutout_stripe/model_best_15.pt')
    f.close()
torch.save(model.state_dict(),'/root/volume/MidProject/cutout_stripe/model_latest_15.pt')
